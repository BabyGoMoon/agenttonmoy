...
/* -----------------------------
   Simple Card family (optional)
------------------------------ */
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cx("tool-card rounded-2xl p-6 transition-transform duration-200", className)}
      {...props}
    />
  )
);
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => <p ref={ref} className={cx("text-sm text-gray-400", className)} {...props} />
);
