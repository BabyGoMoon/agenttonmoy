  ...
  return (
    <>
      <div>
        ...
        <button onClick={togglePopup} className="w-12 h-12 bg-green-600 rounded-full flex justify-center items-center">
          💻
        </button>

        {/* Popup display */}
        {isPopupOpen && (
          <div className="popup-overlay flex justify-center items-center fixed top-0 left-0 right-0 bottom-0 z-50 bg-black bg-opacity-50">
            <div className="social-card-popup bg-white rounded-lg shadow-lg p-6 relative w-72 sm:w-96">
              {/* Social Icons */}
              ...
              <button
                onClick={togglePopup}
                className="absolute top-2 right-2 text-black bg-gray-300 px-4 py-2 rounded-full"
              >
                Close
              </button>
            </div>
