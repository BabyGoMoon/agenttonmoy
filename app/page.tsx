            ...
            <div className="relative overflow-hidden min-h-[600px] sm:min-h-[700px] rounded-xl sm:rounded-2xl mx-1 sm:mx-2 mb-1 sm:mb-2 bg-gradient-to-br from-gray-800 via-gray-900 to-black">
              ...
              <div className="relative z-10 flex">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8 relative overflow-y-auto">
                  {/* Hero */}
                  <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center mb-8 lg:mb-16">
                    ...
                    <div className="h-60 sm:h-80 lg:h-96 rounded-xl p-4 bg-gray-800/30 flex items-center justify-center relative overflow-hidden border border-green-600/30 order-first lg:order-last">
                      ...
                      <div className="absolute inset-0 opacity-30">
                        <div className="h-full w-full bg-gradient-to-b from-transparent via-green-600/5 to-transparent animate-pulse" />
                      </div>
                    </div>
                  </section>

                  {/* Tools */}
                  <section id="tools" className="space-y-6 lg:space-y-8">
